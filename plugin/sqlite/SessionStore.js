...
"use strict";var q=Object.defineProperty;var Ue=Object.getOwnPropertyDescriptor;var Me=Object.getOwnPropertyNames;var we=Object.prototype.hasOwnProperty;var xe=(i,e)=>{for(var t in e)q(i,t,{get:e[t],enumerable:!0})},Fe=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Me(e))!we.call(i,n)&&n!==t&&q(i,n,{get:()=>e[n],enumerable:!(s=Ue(e,n))||s.enumerable});return i};var ke=i=>Fe(q({},"__esModule",{value:!0}),i);var _s={};xe(_s,{SessionStore:()=>oe});module.exports=ke(_s);var re=require("bun:sqlite"),De=require("crypto");var T=require("path"),X=require("os"),U=require("fs"),le=require("url");var Xe=null;function Pe(i){return(Xe??process.stderr.write.bind(process.stderr))(i)}function x(i){Pe(i)}var Es=process.platform==="win32";function Ge(i){return i.replace(/^\uFEFF/,"")}function $(i){return JSON.parse(Ge(i))}var ie="HUMMEM_",Be="CLAUDE_MEM_",ae=new Set,$e=!1;function je(i,e){process.env.HUMMEM_SUPPRESS_LEGACY_ENV_WARNING!=="1"&&x(`[hummem] ${i} is deprecated; use ${e}. The legacy name still works \u2014 see MIGRATION.md.
`)}function He(i,e){ae.has(i)||(ae.add(i),$e&&je(i,e))}function We(i){if(i.startsWith(ie))return Be+i.slice(ie.length)}function de(i,e=process.env){let t=e[i];if(t!==void 0)return t;let s=We(i);if(!s)return;let n=e[s];if(n!==void 0)return e===process.env&&He(s,i),n}var D=require("fs"),V=require("os"),w=require("path"),F="hummem.db",k="claude-mem.db";function qe(i,e=(0,V.homedir)()){return(0,w.resolve)(i)===(0,w.resolve)((0,w.join)(e,".claude-mem"))}var Ve=["-wal","-shm"];function ce(i,{migrate:e=!0,home:t=(0,V.homedir)()}={}){let s=(0,w.join)(i,F),n=(0,w.join)(i,k),r=(0,D.existsSync)(s),o=(0,D.existsSync)(n);if(r&&!o)return{path:s,action:"canonical"};if(r&&o)return{path:s,action:"canonical",detail:`both ${F} and ${k} exist in ${i}; using ${F} and leaving the legacy file untouched. Remove or merge it manually once you have confirmed which one you want.`};if(!o)return{path:s,action:"none"};if(qe(i,t))return{path:n,action:"legacy-retained",detail:`${i} is a legacy data directory shared with another install; using ${k} in place rather than renaming it. Run \`hummem migrate\` to move your memory to its own directory.`};if(!e)return{path:n,action:"legacy-retained",detail:`would rename ${k} to ${F}`};try{let a=[];try{for(let c of Ve){let _=`${n}${c}`;if(!(0,D.existsSync)(_))continue;let u=`${s}${c}`;(0,D.renameSync)(_,u),a.push([u,_])}(0,D.renameSync)(n,s)}catch(c){for(let[_,u]of a)try{(0,D.renameSync)(_,u)}catch{}throw c}return{path:s,action:"migrated",detail:`renamed ${k} to ${F} in ${i}`}}catch(a){return{path:n,action:"legacy-retained",detail:`could not rename ${k} to ${F} (${a instanceof Error?a.message:String(a)}); continuing with the legacy filename`}}}function Ye(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,le.fileURLToPath)(__IMPORT_META_URL__))}var Rs=Ye();function _e(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,X.homedir)():i.startsWith("~/")?(0,T.join)((0,X.homedir)(),i.slice(2)):i}function Ke(){let i=de("HUMMEM_DATA_DIR");if(i)return _e(i);let e=(0,T.join)((0,X.homedir)(),".hummem"),t=(0,T.join)((0,X.homedir)(),".claude-mem");for(let s of[e,t]){let n=(0,T.join)(s,"settings.json");try{if((0,U.existsSync)(n)){let r=$((0,U.readFileSync)(n,"utf-8")),o=r.env??r,a=o.HUMMEM_DATA_DIR??o.CLAUDE_MEM_DATA_DIR;if(a)return _e(a)}}catch{}}return e}var O=Ke(),Je=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,X.homedir)(),".claude"),Os=(()=>{let i=(0,T.join)(Je,"plugins","marketplaces"),e=(0,T.join)(i,"hummem");if((0,U.existsSync)(e))return e;let t=(0,T.join)(i,"thedotmack");return(0,U.existsSync)(t)?t:e})(),Qe=(0,T.join)(O,"logs"),Is=(0,T.join)(O,"settings.json"),Y=ce(O).path,ze=(0,T.join)(O,"observer-sessions"),K=(0,T.basename)(ze);function pe(i){(0,U.mkdirSync)(i,{recursive:!0})}function ue(){let i=process.env.CLAUDE_MEM_WORKER_PORT;return i?`-${i}`:""}var J={dataDir:()=>O,workerPid:()=>(0,T.join)(O,`worker${ue()}.pid`),serverPid:()=>(0,T.join)(O,".server-beta.pid"),serverPort:()=>(0,T.join)(O,".server-beta.port"),serverRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>Y,chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,`supervisor${ue()}.json`),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>Qe};var y=require("fs"),Ee=require("path");var z=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(z||{}),Q=null,Z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=J.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ee.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=J.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=($(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
...
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){Q=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!Q||!(s instanceof Error))return;Q(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},d=new Z;var me=require("crypto");function Te(i,e,t){return(0,me.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function be(i){if(!i)return[];try{let e=JSON.parse(i);return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t.length>0):[]}catch{return[]}}function ee(i=new Date){return i.toISOString().slice(0,10)}var fe=10;function Ne(i,e=new Date,t=fe){let s=ee(e);if(i.includes(s))return i;let n=[...i,s];return n.length>t?n.slice(n.length-t):n}function he(i){let e=ee(new Date(i));return{dates:JSON.stringify([e]),lastReinforced:e}}function ge(i,e,t=new Date){let s=i.prepare("SELECT reinforcement_dates FROM observations WHERE id = ?").get(e);if(!s)return!1;let n=be(s.reinforcement_dates),r=Ne(n,t);return r===n||r.length===n.length&&r[r.length-1]===n[n.length-1]?!1:(i.prepare("UPDATE observations SET reinforcement_dates = ?, last_reinforced = ?, reinforcement_total = COALESCE(reinforcement_total, 0) + 1 WHERE id = ?").run(JSON.stringify(r),r[r.length-1],e),!0)}var l="claude";function Ze(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function A(i){if(!i)return l;let e=Ze(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function Se(i){let e=["claude","codex","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function Re(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
  ...
  `).get()!=null}function P(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function ve(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;P(i,`PRAGMA busy_timeout = ${ns}`,"busy_timeout"),P(i,"PRAGMA foreign_keys = ON","foreign_keys"),P(i,"PRAGMA synchronous = NORMAL","synchronous"),P(i,`PRAGMA journal_size_limit = ${rs}`,"journal_size_limit"),s&&!os(i)&&P(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&P(i,"PRAGMA journal_mode = WAL","journal_mode")}var ye=4096;var is=new Set(["set_title","set_prompt_session","remap_project"]),as=/^(?:0|[1-9][0-9]*)$/,Ce=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function W(i,e={}){return typeof i!="string"||!as.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>Ce&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function te(i){let e=W(i);return BigInt(e)===Ce&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function ds(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!is.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=G(e,["fields","op","target"],"set_title"),o=H(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let c of["memory_session_id","content_session_id","platform_source"])o[c]!==void 0&&M(o[c],c);let a=G(r.fields,["custom_title"],"set_title.fields");M(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=G(e,["fields","op","target"],"set_prompt_session"),o=G(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");cs(o.origin_device_id),W(o.origin_local_id);let a=H(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");M(a.memory_session_id,"memory_session_id");for(let c of["content_session_id","platform_source","project"])a[c]!==void 0&&M(a[c],c);return}let t=G(e,["fields","op","where"],"remap_project"),s=H(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&M(s.project,"project"),s.memory_session_id!==void 0&&M(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&L("remap_project where is empty");let n=H(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&M(n.project,"project"),n.merged_into_project!==void 0&&M(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function ne(i){ds(i)}function cs(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function M(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>ye?L(`${e} must be a non-blank string of at most ${ye} UTF-8 bytes`):i}function G(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${t} must contain exactly: ${r.join(", ")}`),s}function H(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&L(`${t} contains unknown field ${r}`),s}var oe=class{db;constructor(e=Y){e instanceof re.Database?this.db=e:(e!==":memory:"&&pe(O),this.db=new re.Database(e)),ve(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureReinforcementTotalColumn(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.addObservationReinforcementColumns(),this.ensureObservationRelevanceCountColumn(),this.ensureObservationSupersededByColumn(),this.ensureSemanticFactsTable(),this.ensureDeletedObservationsTable(),this.ensureObservationEchoColumns(),this.ensureWorkingMemoryTable()}addObservationReinforcementColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(50),t=this.db.query("PRAGMA table_info(observations)").all(),s=t.some(r=>r.name==="reinforcement_dates"),n=t.some(r=>r.name==="last_reinforced");e&&s&&n||(s||(this.db.run("ALTER TABLE observations ADD COLUMN reinforcement_dates TEXT"),d.debug("DB","Added reinforcement_dates column to observations table")),n||(this.db.run("ALTER TABLE observations ADD COLUMN last_reinforced TEXT"),d.debug("DB","Added last_reinforced column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(50,new Date().toISOString()))}ensureObservationRelevanceCountColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(51),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="relevance_count");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),d.debug("DB","Added relevance_count column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(51,new Date().toISOString()))}ensureObservationSupersededByColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(52),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="superseded_by");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN superseded_by INTEGER"),d.debug("DB","Added superseded_by column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(52,new Date().toISOString()))}ensureSemanticFactsTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(53),s=this.db.query("SELECT name FROM sqlite_master WHERE type = 'table' AND name = 'semantic_facts'").all().length>0;e&&s||(s||(this.db.run(`
    ...
    `).run(t,e),t&&this.requeuePromptSync(e)}enqueueMutationOp(e,t){let s=JSON.parse(JSON.stringify(t));if(s.op==="set_prompt_session"){let n=s.target;n?.origin_device_id===null&&(n.origin_device_id="self")}ne(s),this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?)
    `).run((0,De.randomUUID)(),String(e),JSON.stringify(t),Date.now())}requeuePromptSync(e){let t=this.db.prepare(`
