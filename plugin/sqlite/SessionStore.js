...
"use strict";var q=Object.defineProperty;var Me=Object.getOwnPropertyDescriptor;var we=Object.getOwnPropertyNames;var xe=Object.prototype.hasOwnProperty;var Fe=(i,e)=>{for(var t in e)q(i,t,{get:e[t],enumerable:!0})},ke=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of we(e))!xe.call(i,n)&&n!==t&&q(i,n,{get:()=>e[n],enumerable:!(s=Me(e,n))||s.enumerable});return i};var Xe=i=>ke(q({},"__esModule",{value:!0}),i);var us={};Fe(us,{SessionStore:()=>oe});module.exports=Xe(us);var re=require("bun:sqlite"),Ue=require("crypto");var T=require("path"),X=require("os"),U=require("fs"),le=require("url");var Pe=null;function Ge(i){return(Pe??process.stderr.write.bind(process.stderr))(i)}function x(i){Ge(i)}var ms=process.platform==="win32";function Be(i){return i.replace(/^\uFEFF/,"")}function $(i){return JSON.parse(Be(i))}var ie="HUMMEM_",$e="CLAUDE_MEM_",ae=new Set,je=!1;function He(i,e){process.env.HUMMEM_SUPPRESS_LEGACY_ENV_WARNING!=="1"&&x(`[hummem] ${i} is deprecated; use ${e}. The legacy name still works \u2014 see MIGRATION.md.
`)}function We(i,e){ae.has(i)||(ae.add(i),je&&He(i,e))}function qe(i){if(i.startsWith(ie))return $e+i.slice(ie.length)}function de(i,e=process.env){let t=e[i];if(t!==void 0)return t;let s=qe(i);if(!s)return;let n=e[s];if(n!==void 0)return e===process.env&&We(s,i),n}var D=require("fs"),V=require("os"),w=require("path"),F="hummem.db",k="claude-mem.db";function Ve(i,e=(0,V.homedir)()){return(0,w.resolve)(i)===(0,w.resolve)((0,w.join)(e,".claude-mem"))}var Ye=["-wal","-shm"];function ce(i,{migrate:e=!0,home:t=(0,V.homedir)()}={}){let s=(0,w.join)(i,F),n=(0,w.join)(i,k),r=(0,D.existsSync)(s),o=(0,D.existsSync)(n);if(r&&!o)return{path:s,action:"canonical"};if(r&&o)return{path:s,action:"canonical",detail:`both ${F} and ${k} exist in ${i}; using ${F} and leaving the legacy file untouched. Remove or merge it manually once you have confirmed which one you want.`};if(!o)return{path:s,action:"none"};if(Ve(i,t))return{path:n,action:"legacy-retained",detail:`${i} is a legacy data directory shared with another install; using ${k} in place rather than renaming it. Run \`hummem migrate\` to move your memory to its own directory.`};if(!e)return{path:n,action:"legacy-retained",detail:`would rename ${k} to ${F}`};try{let a=[];try{for(let c of Ye){let _=`${n}${c}`;if(!(0,D.existsSync)(_))continue;let u=`${s}${c}`;(0,D.renameSync)(_,u),a.push([u,_])}(0,D.renameSync)(n,s)}catch(c){for(let[_,u]of a)try{(0,D.renameSync)(_,u)}catch{}throw c}return{path:s,action:"migrated",detail:`renamed ${k} to ${F} in ${i}`}}catch(a){return{path:n,action:"legacy-retained",detail:`could not rename ${k} to ${F} (${a instanceof Error?a.message:String(a)}); continuing with the legacy filename`}}}function Ke(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,le.fileURLToPath)(__IMPORT_META_URL__))}var Os=Ke();function _e(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,X.homedir)():i.startsWith("~/")?(0,T.join)((0,X.homedir)(),i.slice(2)):i}function Je(){let i=de("HUMMEM_DATA_DIR");if(i)return _e(i);let e=(0,T.join)((0,X.homedir)(),".hummem"),t=(0,T.join)((0,X.homedir)(),".claude-mem");for(let s of[e,t]){let n=(0,T.join)(s,"settings.json");try{if((0,U.existsSync)(n)){let r=$((0,U.readFileSync)(n,"utf-8")),o=r.env??r,a=o.HUMMEM_DATA_DIR??o.CLAUDE_MEM_DATA_DIR;if(a)return _e(a)}}catch{}}return e}var O=Je(),Qe=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,X.homedir)(),".claude"),Is=(()=>{let i=(0,T.join)(Qe,"plugins","marketplaces"),e=(0,T.join)(i,"hummem");if((0,U.existsSync)(e))return e;let t=(0,T.join)(i,"thedotmack");return(0,U.existsSync)(t)?t:e})(),ze=(0,T.join)(O,"logs"),As=(0,T.join)(O,"settings.json"),Y=ce(O).path,Ze=(0,T.join)(O,"observer-sessions"),K=(0,T.basename)(Ze);function pe(i){(0,U.mkdirSync)(i,{recursive:!0})}function ue(){let i=process.env.CLAUDE_MEM_WORKER_PORT;return i?`-${i}`:""}var J={dataDir:()=>O,workerPid:()=>(0,T.join)(O,`worker${ue()}.pid`),serverPid:()=>(0,T.join)(O,".server-beta.pid"),serverPort:()=>(0,T.join)(O,".server-beta.port"),serverRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>Y,chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,`supervisor${ue()}.json`),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>ze};var y=require("fs"),Ee=require("path");var z=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(z||{}),Q=null,Z=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=J.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ee.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=J.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=($(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
  ...
  `).get()!=null}function P(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function ye(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;P(i,`PRAGMA busy_timeout = ${rs}`,"busy_timeout"),P(i,"PRAGMA foreign_keys = ON","foreign_keys"),P(i,"PRAGMA synchronous = NORMAL","synchronous"),P(i,`PRAGMA journal_size_limit = ${os}`,"journal_size_limit"),s&&!is(i)&&P(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&P(i,"PRAGMA journal_mode = WAL","journal_mode")}var Ce=4096;var as=new Set(["set_title","set_prompt_session","remap_project"]),ds=/^(?:0|[1-9][0-9]*)$/,De=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function W(i,e={}){return typeof i!="string"||!ds.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>De&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function te(i){let e=W(i);return BigInt(e)===De&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function cs(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!as.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=G(e,["fields","op","target"],"set_title"),o=H(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let c of["memory_session_id","content_session_id","platform_source"])o[c]!==void 0&&M(o[c],c);let a=G(r.fields,["custom_title"],"set_title.fields");M(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=G(e,["fields","op","target"],"set_prompt_session"),o=G(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");_s(o.origin_device_id),W(o.origin_local_id);let a=H(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");M(a.memory_session_id,"memory_session_id");for(let c of["content_session_id","platform_source","project"])a[c]!==void 0&&M(a[c],c);return}let t=G(e,["fields","op","where"],"remap_project"),s=H(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&M(s.project,"project"),s.memory_session_id!==void 0&&M(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&L("remap_project where is empty");let n=H(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&M(n.project,"project"),n.merged_into_project!==void 0&&M(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function ne(i){cs(i)}function _s(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function M(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Ce?L(`${e} must be a non-blank string of at most ${Ce} UTF-8 bytes`):i}function G(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${t} must contain exactly: ${r.join(", ")}`),s}function H(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&L(`${t} contains unknown field ${r}`),s}var oe=class{db;constructor(e=Y){e instanceof re.Database?this.db=e:(e!==":memory:"&&pe(O),this.db=new re.Database(e)),ye(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureReinforcementTotalColumn(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.addObservationReinforcementColumns(),this.ensureObservationRelevanceCountColumn(),this.ensureObservationSupersededByColumn(),this.ensureSemanticFactsTable(),this.ensureDeletedObservationsTable(),this.ensureObservationEchoColumns(),this.ensureWorkingMemoryTable()}addObservationReinforcementColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(50),t=this.db.query("PRAGMA table_info(observations)").all(),s=t.some(r=>r.name==="reinforcement_dates"),n=t.some(r=>r.name==="last_reinforced");e&&s&&n||(s||(this.db.run("ALTER TABLE observations ADD COLUMN reinforcement_dates TEXT"),d.debug("DB","Added reinforcement_dates column to observations table")),n||(this.db.run("ALTER TABLE observations ADD COLUMN last_reinforced TEXT"),d.debug("DB","Added last_reinforced column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(50,new Date().toISOString()))}ensureObservationRelevanceCountColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(51),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="relevance_count");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),d.debug("DB","Added relevance_count column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(51,new Date().toISOString()))}ensureObservationSupersededByColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(52),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="superseded_by");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN superseded_by INTEGER"),d.debug("DB","Added superseded_by column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(52,new Date().toISOString()))}ensureSemanticFactsTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(53),s=this.db.query("SELECT name FROM sqlite_master WHERE type = 'table' AND name = 'semantic_facts'").all().length>0;e&&s||(s||(this.db.run(`
    ...
    `);let s=this.db.prepare("SELECT version, applied_at FROM schema_versions WHERE version = ?").get(47);if(!s){let a=Date.now();this.db.transaction(()=>{this.db.run("DELETE FROM sync_launch_exclusions");for(let{table:u,kind:E}of e)this.db.prepare(`
      ...
      `).all();t=n.length,this.db.run(`
        ...
        WHERE concepts LIKE '%:%' AND json_valid(concepts)
      `);for(let r of n){if(r.origin_device_id!==null)continue;let o=te(r.sync_rev);this.db.prepare(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString())}addObservationsMetadataColumn(){this.db.query("PRAGMA table_info(observations)").all().some(s=>s.name==="metadata")||(this.db.run("ALTER TABLE observations ADD COLUMN metadata TEXT"),d.debug("DB","Added metadata column to observations table (#2116)")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(30,new Date().toISOString())}updateMemorySessionId(e,t){this.db.prepare(`
      ...
      WHERE id = ?
    `).run(t,e),t&&this.requeuePromptSync(e)}enqueueMutationOp(e,t){let s=JSON.parse(JSON.stringify(t));if(s.op==="set_prompt_session"){let n=s.target;n?.origin_device_id===null&&(n.origin_device_id="self")}ne(s),this.db.prepare(`
    ...
    `).get(e);if(!t?.memory_session_id)return;this.db.transaction(()=>{let n=this.db.prepare(`
      ...
      `).all(e);if(n.length!==0)for(let r of n){let o=te(r.sync_rev);this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[K];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(l,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(K),t=[],s=new Set,n={};for(let o of e){let a=A(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let r=Se(Object.keys(n));return{projects:t,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,t,s,n){return Re(this.db,e,j(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],r="";return s&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(A(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e).count}createSDKSession(e,t,s,n,r){let o=new Date,a=o.getTime(),c=r?A(r):l,_=j(s);n&&this.validateSetTitleMutation(e,c,n);let u=this.db.prepare(`
    ...
    `).get(l,c,e);if(u){if(t&&this.db.prepare(`
      ...
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,_,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,c,n),Number(E.lastInsertRowid)}enqueueSetTitleOp(e,t,s){let n=this.validateSetTitleMutation(e,t,s);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,t,s){let n={op:"set_title",target:{content_session_id:e,platform_source:t},fields:{custom_title:s}};return ne(n),n}saveUserPrompt(e,t,s,n){let r=new Date,o=r.getTime(),a=j(s),c=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
    ...
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a){let c=this.storeObservations(e,t,[s],null,n,r,o,a);return{id:c.observationIds[0],createdAtEpoch:c.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),c=new Date(a).toISOString(),u=this.db.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,r,c,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,r,o=0,a,c){let _=a??Date.now(),u=new Date(_).toISOString(),E=he(_);return this.db.transaction(()=>{let h=[],R=this.db.prepare(`
        ...
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let f=Te(e,p.title,p.narrative),C=p.echo_of!=null,m=R.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),r||null,o,p.agent_type??null,p.agent_id??null,f,u,_,c||null,p.metadata??null,C?null:E.dates,C?null:E.lastReinforced,p.echo_of??null);if(m){h.push(m.id);continue}let N=S.get(e,f);if(!N)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${f}`);ge(this.db,N.id,new Date(_)),h.push(N.id)}let v=null;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
