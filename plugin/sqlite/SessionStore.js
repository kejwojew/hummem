...
"use strict";var V=Object.defineProperty;var Me=Object.getOwnPropertyDescriptor;var we=Object.getOwnPropertyNames;var xe=Object.prototype.hasOwnProperty;var Fe=(i,e)=>{for(var t in e)V(i,t,{get:e[t],enumerable:!0})},ke=(i,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of we(e))!xe.call(i,n)&&n!==t&&V(i,n,{get:()=>e[n],enumerable:!(s=Me(e,n))||s.enumerable});return i};var Xe=i=>ke(V({},"__esModule",{value:!0}),i);var us={};Fe(us,{SessionStore:()=>ie});module.exports=Xe(us);var oe=require("bun:sqlite"),Ue=require("crypto");var T=require("path"),X=require("os"),U=require("fs"),pe=require("url");var Pe=null;function Ge(i){return(Pe??process.stderr.write.bind(process.stderr))(i)}function x(i){Ge(i)}var ms=process.platform==="win32";function Be(i){return i.replace(/^\uFEFF/,"")}function $(i){return JSON.parse(Be(i))}var ae="HUMMEM_",$e="CLAUDE_MEM_",de=new Set,je=!1;function He(i,e){process.env.HUMMEM_SUPPRESS_LEGACY_ENV_WARNING!=="1"&&x(`[hummem] ${i} is deprecated; use ${e}. The legacy name still works \u2014 see MIGRATION.md.
`)}function We(i,e){de.has(i)||(de.add(i),je&&He(i,e))}function qe(i){if(i.startsWith(ae))return $e+i.slice(ae.length)}function ce(i,e=process.env){let t=e[i];if(t!==void 0)return t;let s=qe(i);if(!s)return;let n=e[s];if(n!==void 0)return e===process.env&&We(s,i),n}var D=require("fs"),Y=require("os"),w=require("path"),F="hummem.db",k="claude-mem.db";function Ve(i,e=(0,Y.homedir)()){return(0,w.resolve)(i)===(0,w.resolve)((0,w.join)(e,".claude-mem"))}var Ye=["-wal","-shm"];function _e(i,{migrate:e=!0,home:t=(0,Y.homedir)()}={}){let s=(0,w.join)(i,F),n=(0,w.join)(i,k),r=(0,D.existsSync)(s),o=(0,D.existsSync)(n);if(r&&!o)return{path:s,action:"canonical"};if(r&&o)return{path:s,action:"canonical",detail:`both ${F} and ${k} exist in ${i}; using ${F} and leaving the legacy file untouched. Remove or merge it manually once you have confirmed which one you want.`};if(!o)return{path:s,action:"none"};if(Ve(i,t))return{path:n,action:"legacy-retained",detail:`${i} is a legacy data directory shared with another install; using ${k} in place rather than renaming it. Run \`hummem migrate\` to move your memory to its own directory.`};if(!e)return{path:n,action:"legacy-retained",detail:`would rename ${k} to ${F}`};try{let a=[];try{for(let c of Ye){let _=`${n}${c}`;if(!(0,D.existsSync)(_))continue;let u=`${s}${c}`;(0,D.renameSync)(_,u),a.push([u,_])}(0,D.renameSync)(n,s)}catch(c){for(let[_,u]of a)try{(0,D.renameSync)(_,u)}catch{}throw c}return{path:s,action:"migrated",detail:`renamed ${k} to ${F} in ${i}`}}catch(a){return{path:n,action:"legacy-retained",detail:`could not rename ${k} to ${F} (${a instanceof Error?a.message:String(a)}); continuing with the legacy filename`}}}function Ke(){return typeof __dirname<"u"?__dirname:(0,T.dirname)((0,pe.fileURLToPath)(__IMPORT_META_URL__))}var Os=Ke();function ue(i){return typeof i!="string"||i.length===0?i:i==="~"?(0,X.homedir)():i.startsWith("~/")?(0,T.join)((0,X.homedir)(),i.slice(2)):i}function Je(){let i=ce("HUMMEM_DATA_DIR");if(i)return ue(i);let e=(0,T.join)((0,X.homedir)(),".hummem"),t=(0,T.join)((0,X.homedir)(),".claude-mem");for(let s of[e,t]){let n=(0,T.join)(s,"settings.json");try{if((0,U.existsSync)(n)){let r=$((0,U.readFileSync)(n,"utf-8")),o=r.env??r,a=o.HUMMEM_DATA_DIR??o.CLAUDE_MEM_DATA_DIR;if(a)return ue(a)}}catch{}}return e}var O=Je(),Qe=process.env.CLAUDE_CONFIG_DIR||(0,T.join)((0,X.homedir)(),".claude"),Is=(()=>{let i=(0,T.join)(Qe,"plugins","marketplaces"),e=(0,T.join)(i,"hummem");if((0,U.existsSync)(e))return e;let t=(0,T.join)(i,"thedotmack");return(0,U.existsSync)(t)?t:e})(),ze=(0,T.join)(O,"logs"),As=(0,T.join)(O,"settings.json"),K=_e(O).path,Ze=(0,T.join)(O,"observer-sessions"),J=(0,T.basename)(Ze);function Ee(i){(0,U.mkdirSync)(i,{recursive:!0})}function le(){let i=process.env.CLAUDE_MEM_WORKER_PORT;return i?`-${i}`:""}var Q={dataDir:()=>O,workerPid:()=>(0,T.join)(O,`worker${le()}.pid`),serverPid:()=>(0,T.join)(O,".server-beta.pid"),serverPort:()=>(0,T.join)(O,".server-beta.port"),serverRuntime:()=>(0,T.join)(O,".server-beta.runtime.json"),settings:()=>(0,T.join)(O,"settings.json"),database:()=>K,chroma:()=>(0,T.join)(O,"chroma"),combinedCerts:()=>(0,T.join)(O,"combined_certs.pem"),transcriptsConfig:()=>(0,T.join)(O,"transcript-watch.json"),transcriptsState:()=>(0,T.join)(O,"transcript-watch-state.json"),corpora:()=>(0,T.join)(O,"corpora"),supervisorRegistry:()=>(0,T.join)(O,`supervisor${le()}.json`),envFile:()=>(0,T.join)(O,".env"),logsDir:()=>ze};var y=require("fs"),me=require("path");var Z=(r=>(r[r.DEBUG=0]="DEBUG",r[r.INFO=1]="INFO",r[r.WARN=2]="WARN",r[r.ERROR=3]="ERROR",r[r.SILENT=4]="SILENT",r))(Z||{}),z=null,ee=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=Q.logsDir();(0,y.existsSync)(e)||(0,y.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,me.join)(e,`claude-mem-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=Q.settings();if((0,y.existsSync)(e)){let t=(0,y.readFileSync)(e,"utf-8"),n=($(t).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=Z[n]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),r=String(e.getHours()).padStart(2,"0"),o=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),c=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${r}:${o}:${a}.${c}`}log(e,t,s,n,r){if(e<this.getLevel())return;this.ensureLogFileInitialized();let o=this.formatTimestamp(new Date),a=Z[e].padEnd(5),c=t.padEnd(6),_="";n?.correlationId?_=`[${n.correlationId}] `:n?.sessionId&&(_=`[session-${n.sessionId}] `);let u="";if(r!=null)if(r instanceof Error)u=this.getLevel()===0?`
${r.message}
${r.stack}`:` ${r.message}`;else if(this.getLevel()===0&&typeof r=="object")try{u=`
`+JSON.stringify(r,null,2)}catch{u=" "+this.formatData(r)}else u=" "+this.formatData(r);let E="";if(n){let{sessionId:h,memorySessionId:R,correlationId:S,...v}=n;Object.keys(v).length>0&&(E=` {${Object.entries(v).map(([f,C])=>`${f}=${C}`).join(", ")}}`)}let b=`[${o}] [${a}] [${c}] ${_}${s}${E}${u}`;if(this.logFilePath)try{(0,y.appendFileSync)(this.logFilePath,b+`
`,"utf8")}catch(h){let R=h instanceof Error?h:new Error(String(h));x(`[LOGGER] Failed to write to log file: ${R.message}
${R.stack??""}
`)}else x(b+`
`)}debug(e,t,s,n){this.log(0,e,t,s,n)}info(e,t,s,n){this.log(1,e,t,s,n)}warn(e,t,s,n){this.log(2,e,t,s,n)}setErrorSink(e){z=e}error(e,t,s,n){this.log(3,e,t,s,n),this.routeErrorToSink(t,s,n)}routeErrorToSink(e,t,s){try{if(!z||!(s instanceof Error))return;z(s)}catch{}}dataIn(e,t,s,n){this.info(e,`\u2192 ${t}`,s,n)}dataOut(e,t,s,n){this.info(e,`\u2190 ${t}`,s,n)}success(e,t,s,n){this.info(e,`\u2713 ${t}`,s,n)}failure(e,t,s,n){this.error(e,`\u2717 ${t}`,s,n)}},d=new ee;var Te=require("crypto");function be(i,e,t){return(0,Te.createHash)("sha256").update([i||"",e||"",t||""].join("\0")).digest("hex").slice(0,16)}function fe(i){if(!i)return[];try{let e=JSON.parse(i);return Array.isArray(e)?e.filter(t=>typeof t=="string"&&t.length>0):[]}catch{return[]}}function se(i=new Date){return i.toISOString().slice(0,10)}var Ne=10;function he(i,e=new Date,t=Ne){let s=se(e);if(i.includes(s))return i;let n=[...i,s];return n.length>t?n.slice(n.length-t):n}function ge(i){let e=se(new Date(i));return{dates:JSON.stringify([e]),lastReinforced:e}}function Se(i,e,t=new Date){let s=i.prepare("SELECT reinforcement_dates FROM observations WHERE id = ?").get(e);if(!s)return!1;let n=fe(s.reinforcement_dates),r=he(n,t);return r===n||r.length===n.length&&r[r.length-1]===n[n.length-1]?!1:(i.prepare("UPDATE observations SET reinforcement_dates = ?, last_reinforced = ?, reinforcement_total = COALESCE(reinforcement_total, 0) + 1 WHERE id = ?").run(JSON.stringify(r),r[r.length-1],e),!0)}var l="claude";function es(i){return i.trim().toLowerCase().replace(/\s+/g,"-")}function A(i){if(!i)return l;let e=es(i);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:l}function Re(i){let e=["claude","codex","cursor"];return[...i].sort((t,s)=>{let n=e.indexOf(t),r=e.indexOf(s);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:t.localeCompare(s)})}function Oe(i,e,t,s,n){let r=Date.now()-s,o=n!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=n??e;return i.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,t,r)??void 0}var Le=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],j="system-reminder",$s=`<${j}>`,js=`</${j}>`,Ie=new RegExp(`<(${Le.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Hs=new RegExp(`<${j}\\b[^>]*>[\\s\\S]*?</${j}>`,"g"),Ae=100;function ss(i){let e=Object.fromEntries(Le.map(n=>[n,0]));Ie.lastIndex=0;let t=0,s=i.replace(Ie,(n,r)=>(e[r]=(e[r]??0)+1,t+=1,""));return t>Ae&&d.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:t,maxAllowed:Ae,contentLength:i.length}),{stripped:s.trim(),counts:e}}function ve(i){return ss(i).stripped}var ts=["task-notification"],Ws=new RegExp(`^\\s*<(${ts.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),qs=256*1024;var te=4e3;function H(i){let e=i.trim(),s=ve(i).trim()||e;return s.length<=te?s:(d.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:s.length,storedLength:te}),`${s.slice(0,te-1)}\u2026`)}var ns=require("bun:sqlite");var rs=5e3,os=4194304;function is(i){return i.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function P(i,e,t){try{i.run(e)}catch(s){let n=s instanceof Error?s:new Error(String(s));throw d.warn("DB",`Failed to apply SQLite pragma ${t}`,{sql:e},n),s}}function ye(i,e={}){let{enableWal:t=!0,enableIncrementalAutoVacuum:s=!0}=e;P(i,`PRAGMA busy_timeout = ${rs}`,"busy_timeout"),P(i,"PRAGMA foreign_keys = ON","foreign_keys"),P(i,"PRAGMA synchronous = NORMAL","synchronous"),P(i,`PRAGMA journal_size_limit = ${os}`,"journal_size_limit"),s&&!is(i)&&P(i,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),t&&P(i,"PRAGMA journal_mode = WAL","journal_mode")}var Ce=4096;var as=new Set(["set_title","set_prompt_session","remap_project"]),ds=/^(?:0|[1-9][0-9]*)$/,De=18446744073709551615n;function L(i){throw d.debug("CLOUD_SYNC","Rejected invalid canonical content",{reason:i}),new Error(`canonical content: ${i}`)}function q(i,e={}){return typeof i!="string"||!ds.test(i)?L("decimal values must be unsigned base-10 strings without leading zeroes"):(BigInt(i)>De&&L("decimal value exceeds uint64"),e.positive&&i==="0"&&L("decimal value must be positive"),i)}function ne(i){let e=q(i);return BigInt(e)===De&&L("uint64 sequence overflow"),(BigInt(e)+1n).toString(10)}function cs(i){(i===null||typeof i!="object"||Array.isArray(i))&&L("mutation must be an object");let e=i;if((typeof e.op!="string"||!as.has(e.op))&&L("unsupported mutation op"),e.op==="set_title"){let r=G(e,["fields","op","target"],"set_title"),o=W(r.target,["content_session_id","memory_session_id","platform_source"],"set_title.target");o.memory_session_id===void 0&&o.content_session_id===void 0&&L("set_title target requires a session identifier");for(let c of["memory_session_id","content_session_id","platform_source"])o[c]!==void 0&&M(o[c],c);let a=G(r.fields,["custom_title"],"set_title.fields");M(a.custom_title,"custom_title");return}if(e.op==="set_prompt_session"){let r=G(e,["fields","op","target"],"set_prompt_session"),o=G(r.target,["origin_device_id","origin_local_id"],"set_prompt_session.target");_s(o.origin_device_id),q(o.origin_local_id);let a=W(r.fields,["content_session_id","memory_session_id","platform_source","project"],"set_prompt_session.fields");M(a.memory_session_id,"memory_session_id");for(let c of["content_session_id","platform_source","project"])a[c]!==void 0&&M(a[c],c);return}let t=G(e,["fields","op","where"],"remap_project"),s=W(t.where,["memory_session_id","merged_into_project_is_null","project"],"remap_project.where");s.project!==void 0&&M(s.project,"project"),s.memory_session_id!==void 0&&M(s.memory_session_id,"memory_session_id"),s.merged_into_project_is_null!==void 0&&s.merged_into_project_is_null!==!0&&L("merged_into_project_is_null may only be true"),Object.keys(s).length===0&&L("remap_project where is empty");let n=W(t.fields,["merged_into_project","project"],"remap_project.fields");n.project!==void 0&&M(n.project,"project"),n.merged_into_project!==void 0&&M(n.merged_into_project,"merged_into_project"),Object.keys(n).length===0&&L("remap_project fields are empty")}function re(i){cs(i)}function _s(i){return typeof i!="string"||i.length===0||Buffer.byteLength(i,"utf8")>128?L("origin_device_id must be a non-empty string of at most 128 UTF-8 bytes"):i}function M(i,e){return typeof i!="string"||i.length===0||i.trim().length===0||Buffer.byteLength(i,"utf8")>Ce?L(`${e} must be a non-blank string of at most ${Ce} UTF-8 bytes`):i}function G(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=Object.keys(s).sort(),r=[...e].sort();return(n.length!==r.length||n.some((o,a)=>o!==r[a]))&&L(`${t} must contain exactly: ${r.join(", ")}`),s}function W(i,e,t){if(i===null||typeof i!="object"||Array.isArray(i))return L(`${t} must be an object`);let s=i,n=new Set(e),r=Object.keys(s).find(o=>!n.has(o));return r&&L(`${t} contains unknown field ${r}`),s}var ie=class{db;constructor(e=K){e instanceof oe.Database?this.db=e:(e!==":memory:"&&Ee(O),this.db=new oe.Database(e)),ye(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureReinforcementTotalColumn(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),this.ensureSyncedAtColumns(),this.ensureSyncOriginColumns(),this.ensureSyncOutbox(),this.ensureSyncEntityLedger(),this.ensureSyncRevisionTextAffinity(),this.initializeSyncHubLaunchBaseline(),this.normalizeConceptTags(),this.addObservationReinforcementColumns(),this.ensureObservationRelevanceCountColumn(),this.ensureObservationSupersededByColumn(),this.ensureSemanticFactsTable(),this.ensureDeletedObservationsTable(),this.ensureObservationEchoColumns(),this.ensureWorkingMemoryTable()}addObservationReinforcementColumns(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(50),t=this.db.query("PRAGMA table_info(observations)").all(),s=t.some(r=>r.name==="reinforcement_dates"),n=t.some(r=>r.name==="last_reinforced");e&&s&&n||(s||(this.db.run("ALTER TABLE observations ADD COLUMN reinforcement_dates TEXT"),d.debug("DB","Added reinforcement_dates column to observations table")),n||(this.db.run("ALTER TABLE observations ADD COLUMN last_reinforced TEXT"),d.debug("DB","Added last_reinforced column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(50,new Date().toISOString()))}ensureObservationRelevanceCountColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(51),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="relevance_count");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN relevance_count INTEGER DEFAULT 0"),d.debug("DB","Added relevance_count column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(51,new Date().toISOString()))}ensureObservationSupersededByColumn(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(52),s=this.db.query("PRAGMA table_info(observations)").all().some(n=>n.name==="superseded_by");e&&s||(s||(this.db.run("ALTER TABLE observations ADD COLUMN superseded_by INTEGER"),d.debug("DB","Added superseded_by column to observations table")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(52,new Date().toISOString()))}ensureSemanticFactsTable(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(53),s=this.db.query("SELECT name FROM sqlite_master WHERE type = 'table' AND name = 'semantic_facts'").all().length>0;e&&s||(s||(this.db.run(`
    ...
    `),this.db.run(`
      ...
      SELECT
        ...
        status, worker_port, prompt_counter, custom_title
      FROM sdk_sessions
    `),this.db.run("DROP TABLE sdk_sessions"),this.db.run("ALTER TABLE sdk_sessions_new RENAME TO sdk_sessions"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_claude_id ON sdk_sessions(content_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_sdk_id ON sdk_sessions(memory_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_project ON sdk_sessions(project)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_status ON sdk_sessions(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_started ON sdk_sessions(started_at_epoch DESC)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_platform_source ON sdk_sessions(platform_source)"),this.db.run("CREATE UNIQUE INDEX IF NOT EXISTS ux_sdk_sessions_platform_content ON sdk_sessions(platform_source, content_session_id)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(33,new Date().toISOString())}ensureUserPromptsSessionDbId(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34);if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let n=this.db.query("PRAGMA table_info(user_prompts)").all().some(_=>_.name==="session_db_id"),o=this.db.query("PRAGMA foreign_key_list(user_prompts)").all().some(_=>_.table==="sdk_sessions"&&_.from==="content_session_id");if(e&&n&&!o)return;let a=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts_fts'").all().length>0,c=n?`COALESCE(up.session_db_id, (
    ...
    `);let e=new Set(this.db.query("PRAGMA table_info(sync_outbox)").all().map(t=>t.name));e.has("canonical_body")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN canonical_body TEXT"),e.has("operation_sha256")||this.db.run("ALTER TABLE sync_outbox ADD COLUMN operation_sha256 TEXT"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(42,new Date().toISOString())}ensureSyncRevisionTextAffinity(){let e=[{table:"observations",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"session_summaries",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"user_prompts",column:"sync_rev",temporary:"sync_rev_text_v46"},{table:"sync_outbox",column:"rev",temporary:"rev_text_v46"}],t=(o,a)=>this.db.query(`PRAGMA table_info(${o})`).all().find(c=>c.name===a),s=o=>o?.type.trim().toUpperCase()==="TEXT";if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(46)&&e.every(o=>s(t(o.table,o.column))))return;this.db.transaction(()=>{for(let o of e){let a=this.db.query(`PRAGMA table_info(${o.table})`).all(),c=a.find(u=>u.name===o.column);if(!c)throw new Error(`schema v46: missing ${o.table}.${o.column}`);for(let u of this.db.query(`
          SELECT CAST(id AS TEXT) AS row_id,
                 typeof(${o.column}) AS storage_type,
                 CAST(${o.column} AS TEXT) AS revision
          FROM ${o.table}
        `).iterate()){let E=u;if(E.storage_type==="real")throw new Error(`schema v46: ${o.table}.${o.column} row ${E.row_id} is REAL and unrecoverably rounded`);if(E.storage_type!=="integer"&&E.storage_type!=="text")throw new Error(`schema v46: ${o.table}.${o.column} row ${E.row_id} has unsupported ${E.storage_type} storage`);try{q(E.revision,{positive:!0})}catch{throw new Error(`schema v46: ${o.table}.${o.column} row ${E.row_id} is not a positive canonical uint64 revision`)}}if(s(c))continue;if(a.some(u=>u.name===o.temporary))throw new Error(`schema v46: unexpected temporary column ${o.table}.${o.temporary}`);this.db.run(`ALTER TABLE ${o.table} ADD COLUMN ${o.temporary} TEXT NOT NULL DEFAULT '1'`),this.db.run(`UPDATE ${o.table} SET ${o.temporary} = CAST(${o.column} AS TEXT)`);let _=this.db.prepare(`
          SELECT CAST(id AS TEXT) AS row_id
          FROM ${o.table}
          WHERE ${o.temporary} <> CAST(${o.column} AS TEXT)
          LIMIT 1
        `).get();if(_)throw new Error(`schema v46: failed to copy ${o.table}.${o.column} row ${_.row_id} exactly`);this.db.run(`ALTER TABLE ${o.table} DROP COLUMN ${o.column}`),this.db.run(`ALTER TABLE ${o.table} RENAME COLUMN ${o.temporary} TO ${o.column}`)}this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(46,new Date().toISOString())})()}ensureSyncEntityLedger(){this.db.run(`
    ...
    `);let s=this.db.prepare("SELECT version, applied_at FROM schema_versions WHERE version = ?").get(47);if(!s){let a=Date.now();this.db.transaction(()=>{this.db.run("DELETE FROM sync_launch_exclusions");for(let{table:u,kind:E}of e)this.db.prepare(`
          ...
          `).run(a);this.db.run("DELETE FROM sync_outbox"),this.db.run("DELETE FROM sync_content_outbox"),this.db.run("DELETE FROM sync_dead_letter"),this.db.run("DELETE FROM sync_state");let _=new Date(a).toISOString();this.db.prepare("INSERT INTO schema_versions (version, applied_at) VALUES (?, ?)").run(47,_),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(48,_)})();return}if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(48)&&t)return;let r=Date.parse(s.applied_at);if(!Number.isSafeInteger(r)||r<0)throw new Error(`schema v48: invalid v47 applied_at ${s.applied_at}`);this.db.transaction(()=>{for(let{table:a,kind:c}of e)this.db.prepare(`
          ...
          WHERE origin_device_id IS NULL
            AND synced_at > 0
            AND synced_at <= ?
        `).run(c,r);this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(48,new Date().toISOString())})()}normalizeConceptTags(){if(this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(49))return;let t=0;this.db.transaction(()=>{let n=this.db.prepare(`
      ...
      `).all();t=n.length,this.db.run(`
        ...
        WHERE concepts LIKE '%:%' AND json_valid(concepts)
      `);for(let r of n){if(r.origin_device_id!==null)continue;let o=ne(r.sync_rev);this.db.prepare(`
    ...
    `),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(29,new Date().toISOString())}addObservationsMetadataColumn(){this.db.query("PRAGMA table_info(observations)").all().some(s=>s.name==="metadata")||(this.db.run("ALTER TABLE observations ADD COLUMN metadata TEXT"),d.debug("DB","Added metadata column to observations table (#2116)")),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(30,new Date().toISOString())}updateMemorySessionId(e,t){this.db.prepare(`
      ...
      WHERE id = ?
    `).run(t,e),t&&this.requeuePromptSync(e)}enqueueMutationOp(e,t){let s=JSON.parse(JSON.stringify(t));if(s.op==="set_prompt_session"){let n=s.target;n?.origin_device_id===null&&(n.origin_device_id="self")}re(s),this.db.prepare(`
      INSERT INTO sync_outbox (op_uuid, rev, body, created_at_epoch)
      VALUES (?, ?, ?, ?)
    `).run((0,Ue.randomUUID)(),String(e),JSON.stringify(t),Date.now())}requeuePromptSync(e){let t=this.db.prepare(`
    ...
    `).get(e);if(!t?.memory_session_id)return;this.db.transaction(()=>{let n=this.db.prepare(`
      ...
      `).all(e);if(n.length!==0)for(let r of n){let o=ne(r.sync_rev);this.db.prepare(`
    ...
    `).get(e);if(!n)throw new Error(`Session ${e} not found in sdk_sessions`);n.memory_session_id!==t&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,n=[J];return t&&(s+=" AND COALESCE(platform_source, ?) = ?",n.push(l,t)),s+=" ORDER BY project ASC",this.db.prepare(s).all(...n).map(o=>o.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(J),t=[],s=new Set,n={};for(let o of e){let a=A(o.platform_source);n[a]||(n[a]=[]),n[a].includes(o.project)||n[a].push(o.project),s.has(o.project)||(s.add(o.project),t.push(o.project))}let r=Re(Object.keys(n));return{projects:t,sources:r,projectsBySource:Object.fromEntries(r.map(o=>[o,n[o]||[]]))}}getLatestUserPrompt(e,t){let s=this.resolvePromptSessionDbId(e,t),n=s!==null?"up.session_db_id = ?":"up.content_session_id = ?",r=s!==null?s:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(r)}findRecentDuplicateUserPrompt(e,t,s,n){return Oe(this.db,e,H(t),s,this.resolvePromptSessionDbId(e,n)??void 0)}getRecentSessionsWithStatus(e,t=3,s){let n=[e],r="";return s&&(r=`AND COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`,n.push(A(s))),n.push(t),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,A(t))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o,type:a,concepts:c,files:_}=t,u=s==="relevance",E=u?"":`ORDER BY o.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,b=n&&!u?`LIMIT ${n}`:"",h=e.map(()=>"?").join(","),R=[...e],S=[];if(r&&(S.push("(o.project = ? OR o.merged_into_project = ?)"),R.push(r,r)),o&&(S.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),R.push(A(o))),a)if(Array.isArray(a)){let N=a.map(()=>"?").join(",");S.push(`o.type IN (${N})`),R.push(...a)}else S.push("o.type = ?"),R.push(a);if(c){let N=Array.isArray(c)?c:[c],g=N.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");R.push(...N),S.push(`(${g.join(" OR ")})`)}if(_){let N=Array.isArray(_)?_:[_],g=N.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");N.forEach(I=>{R.push(`%${I}%`,`%${I}%`)}),S.push(`(${g.join(" OR ")})`)}let v=S.length>0?`WHERE o.id IN (${h}) AND ${S.join(" AND ")}`:`WHERE o.id IN (${h})`,f=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${v}
      ${E}
      ${b}
    `).all(...R);if(!u)return f;let C=new Map(f.map(N=>[N.id,N])),m=e.map(N=>C.get(N)).filter(N=>!!N);return n?m.slice(0,n):m}getSummaryForSession(e,t){let s=[e],n="";return t&&(n=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,t,s,n,r){let o=new Date,a=o.getTime(),c=r?A(r):l,_=H(s);n&&this.validateSetTitleMutation(e,c,n);let u=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(l,c,e);if(u){if(t&&this.db.prepare(`
        ...
        `).run(t,u.id),n){let b=this.db.prepare("SELECT custom_title FROM sdk_sessions WHERE id = ?").get(u.id);b&&b.custom_title===null&&(this.db.prepare(`
          ...
          `).run(n,u.id),this.enqueueSetTitleOp(e,c,n))}return u.id}let E=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,t,c,_,n||null,o.toISOString(),a);return n&&this.enqueueSetTitleOp(e,c,n),Number(E.lastInsertRowid)}enqueueSetTitleOp(e,t,s){let n=this.validateSetTitleMutation(e,t,s);this.enqueueMutationOp("1",n)}validateSetTitleMutation(e,t,s){let n={op:"set_title",target:{content_session_id:e,platform_source:t},fields:{custom_title:s}};return re(n),n}saveUserPrompt(e,t,s,n){let r=new Date,o=r.getTime(),a=H(s),c=this.resolvePromptSessionDbId(e,n);return this.db.prepare(`
      INSERT INTO user_prompts
      (session_db_id, content_session_id, prompt_number, prompt_text, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?)
    `).run(c,e,t,a,r.toISOString(),o).lastInsertRowid}getUserPrompt(e,t,s){let n=this.resolvePromptSessionDbId(e,s);return n!==null?this.db.prepare(`
        SELECT prompt_text
        FROM user_prompts
      ...
      LIMIT 1
    `).get(e,t)?.prompt_text??null}storeObservation(e,t,s,n,r=0,o,a){let c=this.storeObservations(e,t,[s],null,n,r,o,a);return{id:c.observationIds[0],createdAtEpoch:c.createdAtEpoch}}storeSummary(e,t,s,n,r=0,o){let a=o??Date.now(),c=new Date(a).toISOString(),u=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,t,s.request,s.investigated,s.learned,s.completed,s.next_steps,s.notes,n||null,r,c,a);return{id:Number(u.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,t,s,n,r,o=0,a,c){let _=a??Date.now(),u=new Date(_).toISOString(),E=ge(_);return this.db.transaction(()=>{let h=[],R=this.db.prepare(`
        ...
        RETURNING id
      `),S=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let p of s){let f=be(e,p.title,p.narrative),C=p.echo_of!=null,m=R.get(e,t,p.type,p.title,p.subtitle,JSON.stringify(p.facts),p.narrative,JSON.stringify(p.concepts),JSON.stringify(p.files_read),JSON.stringify(p.files_modified),r||null,o,p.agent_type??null,p.agent_id??null,f,u,_,c||null,p.metadata??null,C?null:E.dates,C?null:E.lastReinforced,p.echo_of??null);if(m){h.push(m.id);continue}let N=S.get(e,f);if(!N)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${f}`);Se(this.db,N.id,new Date(_)),h.push(N.id)}let v=null;if(n){let f=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,t,n.request,n.investigated,n.learned,n.completed,n.next_steps,n.notes,r||null,o,u,_);v=Number(f.lastInsertRowid)}return{observationIds:h,summaryId:v,createdAtEpoch:_}})()}getSessionSummariesByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",c=a?"":`ORDER BY ss.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),E=[...e],b=[];r&&(b.push("(ss.project = ? OR ss.merged_into_project = ?)"),E.push(r,r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),E.push(A(o)));let h=b.length>0?`AND ${b.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT ss.*
      ...
      ${c}
      ${_}
    `).all(...E);if(!a)return S;let v=new Map(S.map(f=>[f.id,f])),p=e.map(f=>v.get(f)).filter(f=>!!f);return n?p.slice(0,n):p}getUserPromptsByIds(e,t={}){if(e.length===0)return[];let{orderBy:s="date_desc",limit:n,project:r,platformSource:o}=t,a=s==="relevance",c=a?"":`ORDER BY up.created_at_epoch ${s==="date_asc"?"ASC":"DESC"}`,_=n&&!a?`LIMIT ${n}`:"",u=e.map(()=>"?").join(","),E=[...e],b=[];r&&(b.push("s.project = ?"),E.push(r)),o&&(b.push(`COALESCE(NULLIF(s.platform_source, ''), '${l}') = ?`),E.push(A(o)));let h=b.length>0?`AND ${b.join(" AND ")}`:"",S=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${c}
      ${_}
    `).all(...E);if(!a)return S;let v=new Map(S.map(f=>[f.id,f])),p=e.map(f=>v.get(f)).filter(f=>!!f);return n?p.slice(0,n):p}getTimelineAroundTimestamp(e,t=10,s=10,n,r){return this.getTimelineAroundObservation(null,e,t,s,n,r)}getTimelineAroundObservation(e,t,s=10,n=10,r,o){let a=o?A(o):void 0,c=(m,N,g=!1)=>{let I=[],B=[];return r&&(g?(I.push(`(${m}.project = ? OR ${m}.merged_into_project = ?)`),B.push(r,r)):(I.push(`${m}.project = ?`),B.push(r))),a&&(I.push(`COALESCE(NULLIF(${N}.platform_source, ''), '${l}') = ?`),B.push(a)),{clause:I.length>0?`AND ${I.join(" AND ")}`:"",params:B}},_=c("o","src",!0),u=c("ss","src",!0),E=c("s","s"),b,h;if(e!==null){let m=`
      ...
      `,N=`
        ...
        LIMIT ?
      `;try{let g=this.db.prepare(m).all(t,..._.params,s),I=this.db.prepare(N).all(t,..._.params,n+1);if(g.length===0&&I.length===0)return{observations:[],sessions:[],prompts:[]};b=g.length>0?g[g.length-1].created_at_epoch:t,h=I.length>0?I[I.length-1].created_at_epoch:t}catch(g){return g instanceof Error?d.error("DB","Error getting boundary timestamps",{project:r},g):d.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(g))),{observations:[],sessions:[],prompts:[]}}}let R=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
