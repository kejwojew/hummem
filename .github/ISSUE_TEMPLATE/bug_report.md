...
- [ ] I searched [existing issues](https://github.com/kejwojew/hummem/issues) and confirmed this is not a duplicate
...
- **Path**: `~/.hummem/logs/worker-YYYY-MM-DD.log`
- **Example**: `~/.hummem/logs/worker-2025-12-14.log`
