...
│    "run: npx hummem repair" to stderr. Always exits 0.      │
└─────────────────────────────────────────────────────────────────┘
                              ↓
┌─────────────────────────────────────────────────────────────────┐
...
The actual runtime install (Bun, uv, `bun install`) is performed by `npx hummem install` / `npx hummem repair` with a visible installer spinner; the Setup hook itself only reads the `.install-version` marker.
