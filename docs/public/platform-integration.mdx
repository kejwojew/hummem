...
**Tag Stripping:** Removes `<private>` and `<hummem-context>` tags before storage.
...
<CardGroup cols={2}>
  <Card title="Documentation" icon="book" href="https://github.com/kejwojew/hummem">
    Complete claude-mem documentation
  </Card>
  <Card title="GitHub" icon="github" href="https://github.com/kejwojew/hummem">
