...
4. Writes it to `CLAUDE.md` in that folder (inside `<hummem-context>` tags)
...
The auto-generated content is wrapped in `<hummem-context>` tags. **Any content you write outside these tags is preserved** when the file is regenerated. This means you can:
...
2. Strips `<hummem-context>...</hummem-context>` sections
